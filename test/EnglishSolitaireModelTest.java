...
/**
 * This is a test class that tests all the functions in the EnglishSolitaireModel class.
 */
public class EnglishSolitaireModelTest {
  ...
  public void initData() {
    ...
    gameCornerEmpty = new EnglishSolitaireModel(0,4);
    gameBottomEmpty = new EnglishSolitaireModel(3, 3, 6);
    bigGame = new EnglishSolitaireModel(101);

  }

  @Test
  public void makeValidGame() {
    EnglishSolitaireModel game4 = new EnglishSolitaireModel();
    EnglishSolitaireModel game7 = new EnglishSolitaireModel(7);
    EnglishSolitaireModel gameLeftCornerEmpty = new EnglishSolitaireModel(0,2);
    EnglishSolitaireModel gameTopEmpty =
            new EnglishSolitaireModel(3, 3, 0);
    assertEquals(32, game4.getScore());
    assertEquals(216, game7.getScore());
  ...
  public void makeInvalidGame() {
    try {
      MarbleSolitaireModel coolGame = new EnglishSolitaireModel(4);
    ...
    try {
      MarbleSolitaireModel coolGame = new EnglishSolitaireModel(0, 0);
      fail("Constructor did not throw IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
    ...
    try {
      MarbleSolitaireModel coolGame = new EnglishSolitaireModel(4, 3, 3);
      fail("Constructor did not throw IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
      assertEquals("Invalid arm thickness: 4", e.getMessage());
    ...
    try {
      MarbleSolitaireModel coolGame = new EnglishSolitaireModel(3, 0, 0);
      fail("Constructor did not throw IllegalArgumentException");
    }
    catch (IllegalArgumentException e) {
      assertEquals("Invalid empty cell position (0,0)", e.getMessage());
  ...
  public void getScore() {
    assertEquals(32,game3.getScore());
    game3.move(1,3,3,3);
    assertEquals(31,game3.getScore());
